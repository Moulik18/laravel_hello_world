...
<button data-clipboard-text="laravel new your-project-name">Copy</button>
...
In this version, I've replaced the `composer create-project` command with the `laravel new` command as per your request. Each code block still has a corresponding "Copy" button.
